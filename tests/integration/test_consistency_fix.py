...
def test_crear_profesional_con_matriculas():
    ...
    try:
        ...
        print(f"✅ Test passed: Professional created with {len(profesional_creado.matriculas)} matricula(s)")
...
def test_crear_profesional_sin_matriculas_debe_funcionar():
    ...
    try:
        ...
        print("✅ Test passed: Professional created without matriculas (violates RN-001)")
