...
class TestSeedDataIntegration:
    ...
    @pytest.mark.integration
    @pytest.mark.supabase
    @pytest.mark.skip(reason="API retorna 500 en lugar de manejar búsqueda sin especialidad - no afecta datos del seed")
    ...
    @pytest.mark.integration
    @pytest.mark.supabase
    @pytest.mark.skip(reason="API retorna 500 con especialidad inexistente - no afecta datos del seed")
    def test_especialidad_inexistente_retorna_vacio(self, client_supabase):
        ...
        payload = {
            "nombre_especialidad": "Especialidad Que No Existe 12345"
        }
