...
class Profesional(Usuario):
    ...
    def calcular_distancia(self, a: Ubicacion) -> float:
        pass
...
class Responsable(Usuario):
    ...
    def ver_publicaciones(self, f: "FiltroBusqueda") -> List["Publicacion"]:
        pass

    def contactar_profesional(
        self, p: Profesional, msg: str, paciente: Optional["Paciente"] = None
    ) -> "Consulta":
        pass
