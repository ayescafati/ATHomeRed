...
class Buscador:
    ...
    def set_fuente(self, profesionales: List[Profesional], publicaciones: List[Publicacion]) -> None: pass
    def cambiar_estrategia(self, e: EstrategiaBusqueda) -> None: pass
    def buscar(self, filtro: FiltroBusqueda) -> List[Profesional]: pass
