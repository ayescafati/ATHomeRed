...
def upgrade() -> None:
    ...
    op.create_table('estado_consulta',
    ...
    op.create_table('relacion_solicitante',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.CheckConstraint('(es_profesional = TRUE) OR (es_solicitante = TRUE)', name='ck_usuario_al_menos_un_rol'),
    sa.CheckConstraint('NOT (es_profesional = TRUE AND es_solicitante = TRUE)', name='ck_usuario_roles_exclusivos'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('nombre', sa.VARCHAR(length=50), nullable=False),
    sa.ForeignKeyConstraint(['provincia_id'], ['athome.provincia.id'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('provincia_id', 'nombre', name='uq_departamento_provincia_nombre'),
    schema='athome'
    )
    op.create_index('ix_departamento_provincia', 'departamento', ['provincia_id'], unique=False, schema='athome')
    op.create_table('barrio',
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('departamento_id', sa.UUID(), nullable=False),
    sa.Column('nombre', sa.VARCHAR(length=50), nullable=False),
    sa.ForeignKeyConstraint(['departamento_id'], ['athome.departamento.id'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('departamento_id', 'nombre', name='uq_barrio_departamento_nombre'),
    schema='athome'
    )
    op.create_index('ix_barrio_departamento', 'barrio', ['departamento_id'], unique=False, schema='athome')
    ...
    sa.CheckConstraint('(latitud is null and longitud is null) or (latitud between -90 and 90 and longitud between -180 and 180)', name='ck_dir_latlon'),
    sa.ForeignKeyConstraint(['barrio_id'], ['athome.barrio.id'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id'),
    schema='athome'
    )
    op.create_index('ix_direccion_barrio', 'direccion', ['barrio_id'], unique=False, schema='athome')
    ...
    sa.ForeignKeyConstraint(['direccion_id'], ['athome.direccion.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['usuario_id'], ['athome.usuario.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.ForeignKeyConstraint(['profesional_id'], ['athome.profesional.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    schema='athome'
    )
    op.create_index('ix_disp_profesional', 'disponibilidad', ['profesional_id'], unique=False, schema='athome')
    ...
    sa.CheckConstraint('vigente_hasta >= vigente_desde', name='ck_matricula_fechas'),
    sa.ForeignKeyConstraint(['profesional_id'], ['athome.profesional.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['provincia_id'], ['athome.provincia.id'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('profesional_id', 'provincia_id', 'nro_matricula', name='uq_matricula_prof_prov_nro'),
    schema='athome'
    )
    op.create_index('ix_matricula_profesional', 'matricula', ['profesional_id'], unique=False, schema='athome')
    op.create_index('ix_matricula_provincia', 'matricula', ['provincia_id'], unique=False, schema='athome')
    ...
    sa.CheckConstraint('fecha_nacimiento IS NULL OR fecha_nacimiento <= CURRENT_DATE', name='ck_paciente_fecha_nac_pasada'),
    sa.ForeignKeyConstraint(['direccion_id'], ['athome.direccion.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['relacion_id'], ['athome.relacion_solicitante.id'], ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['solicitante_id'], ['athome.solicitante.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('solicitante_id', name='uq_paciente_solicitante'),
    schema='athome'
    )
    op.create_table('profesional_especialidad',
    sa.Column('profesional_id', sa.UUID(), nullable=False),
    sa.Column('especialidad_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['especialidad_id'], ['athome.especialidad.id_especialidad'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['profesional_id'], ['athome.profesional.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('profesional_id', 'especialidad_id'),
    schema='athome'
    )
    op.create_index('ix_prof_esp_especialidad', 'profesional_especialidad', ['especialidad_id'], unique=False, schema='athome')
    op.create_index('ix_prof_esp_profesional', 'profesional_especialidad', ['profesional_id'], unique=False, schema='athome')
    ...
    sa.ForeignKeyConstraint(['especialidad_id'], ['athome.especialidad.id_especialidad'], ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['profesional_id'], ['athome.profesional.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    schema='athome'
    )
    op.create_index('ix_pub_especialidad', 'publicacion', ['especialidad_id'], unique=False, schema='athome')
    op.create_index('ix_pub_profesional', 'publicacion', ['profesional_id'], unique=False, schema='athome')
    ...
    sa.ForeignKeyConstraint(['direccion_servicio_id'], ['athome.direccion.id'], ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['estado_id'], ['athome.estado_consulta.id'], ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['paciente_id'], ['athome.paciente.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['profesional_id'], ['athome.profesional.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    schema='athome'
    )
    op.create_index('ix_consulta_fecha', 'consulta', ['fecha'], unique=False, schema='athome')
    op.create_index('ix_consulta_paciente', 'consulta', ['paciente_id'], unique=False, schema='athome')
    op.create_index('ix_consulta_profesional', 'consulta', ['profesional_id'], unique=False, schema='athome')
    ...
    sa.Column('creado_en', sa.Date(), server_default=sa.text('CURRENT_DATE'), nullable=False),
    sa.CheckConstraint('puntuacion BETWEEN 1 AND 5', name='ck_valoracion_puntuacion_1_5'),
    sa.ForeignKeyConstraint(['paciente_id'], ['athome.paciente.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['profesional_id'], ['athome.profesional.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    schema='athome'
    )
    op.create_index('ix_valoracion_profesional_fecha', 'valoracion', ['profesional_id', 'creado_en'], unique=False, schema='athome')
    op.create_table('evento',
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('consulta_id', sa.UUID(), nullable=False),
    sa.Column('tipo', sa.String(), nullable=False),
    sa.Column('datos', sa.JSON(), nullable=False),
    sa.ForeignKeyConstraint(['consulta_id'], ['athome.consulta.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    schema='athome'
    )
...
def downgrade() -> None:
    ...
    op.drop_index('ix_valoracion_profesional_fecha', table_name='valoracion', schema='athome')
    ...
    op.drop_index('ix_prof_esp_profesional', table_name='profesional_especialidad', schema='athome')
    op.drop_index('ix_prof_esp_especialidad', table_name='profesional_especialidad', schema='athome')
    ...
    op.drop_index('ix_departamento_provincia', table_name='departamento', schema='athome')
