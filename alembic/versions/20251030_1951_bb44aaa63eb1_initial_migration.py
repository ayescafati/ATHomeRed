...
def upgrade() -> None:
    ...
    op.create_table(
        "especialidad",
        sa.Column(
            "id_especialidad", sa.Integer(), autoincrement=True, nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "notas", sa.Text(), server_default=sa.text("''"), nullable=False
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_consulta_profesional", table_name="consulta", schema="athome"
    )
    op.drop_index(
        "ix_consulta_paciente", table_name="consulta", schema="athome"
    )
    op.drop_index("ix_consulta_fecha", table_name="consulta", schema="athome")
    op.drop_table("consulta", schema="athome")
    op.drop_index(
        "ix_pub_profesional", table_name="publicacion", schema="athome"
    )
    op.drop_index(
        "ix_pub_especialidad", table_name="publicacion", schema="athome"
    )
    ...
    op.drop_index(
        "ix_matricula_provincia", table_name="matricula", schema="athome"
    )
    op.drop_index(
        "ix_matricula_profesional", table_name="matricula", schema="athome"
    )
    op.drop_table("matricula", schema="athome")
    op.drop_index(
        "ix_disp_profesional", table_name="disponibilidad", schema="athome"
    )
    op.drop_table("disponibilidad", schema="athome")
    op.drop_table("solicitante", schema="athome")
    op.drop_table("profesional", schema="athome")
    op.drop_index(
        "ix_direccion_barrio", table_name="direccion", schema="athome"
    )
    op.drop_table("direccion", schema="athome")
    op.drop_index(
        "ix_barrio_departamento", table_name="barrio", schema="athome"
    )
