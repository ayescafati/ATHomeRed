    ...
    try:
        ...
        for comuna_idx, nombres in barrios_data:
            for nombre in nombres:
                barrio = BarrioORM(departamento_id=comunas[comuna_idx].id, nombre=nombre)
                s.add(barrio)
        ...
        calles_por_barrio = [
            ['Av. del Libertador', 'Reconquista'], ['Av. Corrientes', 'Maipú'], ['Av. de Mayo', 'Perú'],
            ['Caminito', 'Brandsen'], ['Av. Montes de Oca', 'Iriarte'], ['Av. Caseros', 'Uspallata'],
            ['Av. Cruz', 'Soldado de la Frontera'], ['Mariano Acosta', 'Av. Int. Roca'], ['Av. Gral. Paz', 'Pergamino'],
            ['Ramón Falcón', 'Montiel'], ['Av. Emilio Castro', 'Murguiondo'], ['Av. Directorio', 'Lacarra'],
            ['Av. Avellaneda', 'Bahía Blanca'], ['Av. Rivadavia', 'Corvalán'], ['Álvarez Jonte', 'J. V. González'],
            ['Nueva York', 'Asunción'], ['Cuenca', 'Av. Nazca'], ['Álvarez Jonte', 'Helguera'],
            ['Av. Ricardo Balbín', 'Vedia'], ['Av. Triunvirato', 'Bauness'], ['Artigas', 'Bolivia'],
            ['Av. Cabildo', 'Juramento'], ['Av. Federico Lacroze', 'Conesa'], ['Av. Cabildo', 'Crisólogo Larralde'],
        ]
        ...
        especialidades = [
            ...
            EspecialidadORM(nombre="Acompañamiento Terapéutico Geriatría", tarifa=15000),
            EspecialidadORM(nombre="Acompañamiento Terapéutico (Especialización TEA/TDAH)", tarifa=15000),
        ...
        relaciones_data = [
            (35, 'Yo mismo'), (36, 'Madre'), (37, 'Padre'), (38, 'Hijo'), (39, 'Hija'),
            (40, 'Hermano'), (41, 'Hermana'), (42, 'Esposo'), (43, 'Esposa'),
            (44, 'Abuelo'), (45, 'Abuela'), (46, 'Tío'), (47, 'Tía'),
            (48, 'Tutor/a'), (49, 'Otro familiar')
        ]
        ...
        nombres = ['Juan', 'María', 'Carlos', 'Ana', 'Roberto', 'Laura', 'Diego', 'Patricia', 'Miguel', 'Gabriela',
                   'Fernando', 'Claudia', 'Ricardo', 'Silvia', 'Jorge', 'Mónica', 'Pablo', 'Sandra', 'Martín', 'Liliana']
        apellidos = ['González', 'Rodríguez', 'Fernández', 'López', 'Martínez', 'Sánchez', 'Pérez', 'García', 'Romero', 'Díaz',
                     'Torres', 'Álvarez', 'Ruiz', 'Moreno', 'Jiménez', 'Muñoz', 'Castillo', 'Castro', 'Ortiz', 'Silva']
        
        especialidades_dist = (
            [especialidades[0]] * 30 +  # 30 AT General
            [especialidades[1]] * 15 +  # 15 AT Geriatría
            [especialidades[2]] * 10 +  # 10 AT TEA/TDAH
            [especialidades[3]] * 20 +  # 20 Enfermería
            [especialidades[4]] * 15 +  # 15 Enfermería Geriátrica
            [especialidades[5]] * 10    # 10 Cuidados Paliativos
        )
        ...
        for i in range(100):
            ...
            # Matrícula
            provincia_mat = "Ciudad Autónoma de Buenos Aires" if i % 2 == 0 else "Buenos Aires"
            prefijo_loc = "CABA" if i % 2 == 0 else "PBA"
            prefijo_tipo = "AT" if "Acompañamiento" in especialidades_dist[i].nombre else "EF"
        ...
        nombres_ninos = ['Mateo', 'Sofía', 'Benjamín', 'Martina', 'Lucas', 'Emma', 'Thiago', 'Valentina', 'Santino', 'Isabella']
        nombres_adultos = ['Carlos', 'María', 'Roberto', 'Ana', 'Jorge', 'Laura', 'Fernando', 'Patricia', 'Diego', 'Claudia']
        nombres_mayores = ['Alberto', 'Rosa', 'Héctor', 'Elsa', 'Raúl', 'Mirta', 'Oscar', 'Nora', 'Rubén', 'Lidia']
        ...
        for i in range(50):
            ...
            elif esp_nombre in ["Acompañamiento Terapéutico Geriatría", "Enfermería Geriátrica", "Cuidados Paliativos"]:
                edad = random.randint(65, 90)
                nombre_paciente = random.choice(nombres_mayores)
                relacion_id = random.choice([35, 38, 39, 42, 43])  # Yo mismo, Hijo, Hija, Esposo/a
            else:
        ...
        print("=" * 80)
        print(f"\n📊 Totales:")
        print(f"   Provincias: 1")
        print(f"   Departamentos: 8")
        print(f"   Barrios: 24")
        print(f"   Direcciones: 48")
        print(f"   Especialidades: 6")
        print(f"   Relaciones: 15")
        print(f"   Profesionales: 100")
        print(f"   Solicitantes: 50")
        print(f"   Pacientes: 50")
