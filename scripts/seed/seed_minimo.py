    ...
    try:
        ...
        profesionales_data = [
            ...
            },
            {
                ...
                "celular": "351-7654321",
                "especialidades": ["Acompañamiento Terapéutico", "Cuidados Geriátricos"]
            },
        ]
        ...
        if not prov_res:
            prov_id = str(uuid4())
            session.execute(
                text("INSERT INTO athome.provincia (id, nombre) VALUES (:id, :nombre) ON CONFLICT DO NOTHING"),
        ...
        print("=" * 70)
        print("\n📊 Datos creados:")
        print(f"   • 3 Especialidades")
        print(f"   • 2 Profesionales")
        print(f"   • 2 Solicitantes con pacientes")
        print("\n🔐 Credenciales:")
