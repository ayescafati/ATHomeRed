...
def main():
    ...
    cita.completar(
        notas_finales="Curación realizada correctamente. Paciente estable. Control en 7 días."
    )
    print(f"✅ Estado actual: {cita.estado.value}")
    ...
    # Paciente cancela
    cita2.cancelar(
        motivo="Surgió un imprevisto familiar", cancelado_por=f"paciente:{paciente_id}"
    )
    print("✅ Cita cancelada por paciente")
    ...
    print()
    print(
        "✨ En TODOS los casos, el Observer (NotificadorEmail) se dispara automáticamente"
    )
    print("=" * 80)
