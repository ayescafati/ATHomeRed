...
from app.api.schemas import ValoracionCreate, ValoracionResponse, PromedioValoracionResponse
from app.api.dependencies import get_valoracion_repository, get_profesional_repository, get_paciente_repository
...
@router.get("/profesional/{profesional_id}/promedio", response_model=PromedioValoracionResponse)
